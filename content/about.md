...
The models in the mix are a combination of [Claude](https://claude.ai) (Anthropic) and self-hosted open-weight models running on local infrastructure. The self-hosted stack exists partly because I believe in keeping sensitive workloads off third-party APIs, and partly because running your own inference is just more interesting.
